...
WAC.Helicopter.GetWeapon=function(n,t2)
	local t=table.Copy(WAC.Helicopter.Weapons[n] or WAC.Helicopter.Weapons["No Weapon"])
	if t2 then
		table.Merge(t,t2)
	end
	return t
...
if SERVER then
	...
	local tbl={
		[WAC_AIR_LEANP]	={1,"Lean Forward/Back"},
		[WAC_AIR_LEANY]	={1,"Turn Left/Right"},
		[WAC_AIR_LEANR]	={1,"Roll Left/Right"},
		[WAC_AIR_UPDOWN]	={1,"Thrust"},
		[WAC_AIR_START]	={1,"Turn On/Off"},
		[WAC_AIR_FIRE]		={1,"Shoot"},
		[WAC_AIR_CAM]		={1,"Toggle Camera"},
		[WAC_AIR_NEXTWEP]	={1,"Next Weapon"},
		[WAC_AIR_HOVER]	={1,"Auto Hover Toggle"},
		[WAC_AIR_EXIT]		={1,"Exit Helicopter"},
		[WAC_AIR_FREEAIM]	={1,"Free Aim"},
	}
	...
	wac.hook("JoystickInitialize", "wac_air_jcon_init", function()
		for k, v in pairs(tbl) do
			jcon.register({
				uid="wac_air_"..k,
				type=((v[1]==1)and("analog")or("digital")),
				description=v[2],
